...
const HeroSection = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setAgencyIdx((i) => (i + 1) % agencyWords.length);
    }, 2200);
  ...
  return (
    <section id="home" className="relative w-full py-12 md:py-20 px-6 md:px-12 flex flex-col items-center justify-center overflow-hidden bg-background">
      ...
      >
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-medium tracking-tighter text-balance text-foreground flex flex-wrap items-center justify-center gap-2">
          <span>Connecting Content Creators with</span>
          <span className="inline-block min-w-[120px] text-primary">
            <TypeAnimation
              sequence={agencyWords.flatMap(word => [word, 2000])}
              speed={30}
              repeat={Infinity}
              cursor={true}
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-balance">
          Discover new projects, grow your brand, and collaborate easily.
        </p>
          ...
          <div className="bg-card backdrop-blur-md w-full">
            <div className="flex items-center justify-between p-4 border-b border-border">
              <div className="flex items-center gap-4">
                ...
                <span className="text-foreground font-medium">Collaboration Campaign Dashboard</span>
              </div>
              
              <div className="flex items-center gap-3">
                <div className="flex -space-x-2">
                  <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Ava Carter" className="h-8 w-8 rounded-full border-2 border-card object-cover" />
                  <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="Liam Smith" className="h-8 w-8 rounded-full border-2 border-card object-cover" />
                  <img src="https://randomuser.me/api/portraits/women/65.jpg" alt="Sophia Lee" className="h-8 w-8 rounded-full border-2 border-card object-cover" />
                  <img src="https://randomuser.me/api/portraits/men/76.jpg" alt="Noah Kim" className="h-8 w-8 rounded-full border-2 border-card object-cover flex items-center justify-center text-xs text-foreground" />
              ...
              <div className="flex-1 p-4 bg-background overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-6 min-w-0">
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <h3 className="font-medium text-foreground">Active Campaigns</h3>
                    <span className="text-xs bg-muted px-2 py-1 rounded-full text-muted-foreground">5</span>
                  </div>
